...
def resid_detections_plotter(epoch_name, dr_path = '/g/ghez/data/dr/dr1',
    ...
    stf_res_versions = ['combo', 'legacy_res', 'singPSF_res']
    ...
    for stf_res_version in stf_res_versions:
        ...
        ax.set_xlim([center_op_x - 5.3/plate_scale,
                     center_op_x + 5.3/plate_scale])
        ax.set_ylim([center_op_y - 6.5/plate_scale,
                     center_op_y + 4.1/plate_scale])
        ...
        fig.savefig(plot_out_dir + 'resid_{0}.pdf'.format(stf_res_version), transparent=True)
        fig.savefig(plot_out_dir + 'resid_{0}.png'.format(stf_res_version), transparent=True, dpi=200)
